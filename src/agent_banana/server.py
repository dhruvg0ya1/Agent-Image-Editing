...
<body>
  ...
  <div class="sidebar">
    ...
    <img src="https://cdn-uploads.huggingface.co/production/uploads/68f7eb6c3f706d5831b3e4b6/rgK8CzbI57Fkn5HrDfxtu.png" style="width:32px;height:32px;border-radius:8px;object-fit:contain;" />
      <h1>Moleculyst</h1>
    </div>
  ...
  <div class="main">
    ...
    <div class="chat" id="chat">
      ...
      <img src="https://cdn-uploads.huggingface.co/production/uploads/68f7eb6c3f706d5831b3e4b6/rgK8CzbI57Fkn5HrDfxtu.png" style="width:64px;height:64px;border-radius:8px;object-fit:contain;" />
